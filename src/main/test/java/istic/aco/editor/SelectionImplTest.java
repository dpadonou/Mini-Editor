...
class SelectionImplTest {
    ...
    void beginIndexShouldBeLowerThanEndIndex() {
        ...
        String msg = "L'index de fin doit �tre sup�rieure ou �gale � l'index de d�but.";
    ...
    void beginIndexShouldBeGreaterThan0() {
        ...
        String msg = "L'index de d�but doit �tre sup�rieure ou �gale � 0.";
        assert (msg.equals(exception.getMessage()));
    }
    ...
    void setBeginIndex2() {
        ...
        String msg = "L'index de d�but doit �tre inf�rieure ou �gale � l'index de fin.";
        assert (msg.equals(exception.getMessage()));
    }
    ...
    void setBeginIndex3() {
        ...
        String msg = "L'index de d�but est hors du buffer.";
        assert (msg.equals(exception.getMessage()));
    }
    ...
    void setEndIndex1() {
        ...
        String msg = "L'index de fin doit �tre sup�rieure ou �gale � 0.";
        assert (msg.equals(exception.getMessage()));
    }
